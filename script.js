...
//ISSO DAQUI E A SELAEÇÃO DE CASAS E AS CASA PRA QUAL POSTERIORMENTE SERÃO VERIFICADAS PARA VER SE PODE OU NÃO MOVER A PEÇA PRA LA
let selectedPiece = {
    pieceId: -1,
    indexOfBoardPiece: -1,
    isKing: false,
...
//ISSO AQUI DA O MOVIMENTO DAS PEÇAS
...
//NESSA PARTE E DADA AS PEÇAS DE CADA JOGADOR
...
// E ISSO DAQUI RESTRINGE OS MESMOS
...
// ISSO AQUI DIZ O QUE NÃO PODE SER FEITO PELA PEÇA "KING"
...
// TODA A CONFIGURAÇÃO DOS CLICKS
...
function checkForWin() {
    if (blackScore === 0) {
        ...
        for (let i = 0; i < redTurnText.length; i++) {
            ...
            redTurnText[i].textContent = "VITORIA DAS VERMELHAS!";
        }
    } else if (redScore === 0) {
        divider.style.display = "none";
        for (let i = 0; i < blackTurntext.length; i++) {            
            ...
            blackTurntext[i].textContent = "VITORIA DAS PRETAS!";
        }
    }
    changePlayer();
}

// ISSO AQUI MUDA AS VEZES EM TURNOS
